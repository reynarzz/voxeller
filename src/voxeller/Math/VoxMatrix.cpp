...
namespace Voxeller
{
	...
	vox_mat3& vox_mat3::operator*=(const vox_mat3& o) { return *this = *this * o; }
	vox_mat3& vox_mat3::operator*=(f32 s) { return *this = *this * s; }
	...
	vox_mat4& vox_mat4::operator*=(const vox_mat4& o) { return *this = *this * o; }
	vox_mat4& vox_mat4::operator*=(f32 s) { return *this = *this * s; }
	...
	vox_imat2& vox_imat2::operator*=(s32 s) { return *this = *this * s; }
